<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class=""><a href="takeAttendance.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Attendance</a></li>
		...
		<li class=""><a href="add_assignment.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add Material</a></li>
		<li class=""><a href="insert_marks1.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Grades</a></li>
		<li class="active"><a href="quiz_option.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Quiz</a></li>
