...
<head>
    ...
    <style>
        ...
        table, th, td {
            border: 1px solid #d81b60; /* Border color */
        }
        ...
        th {
            background-color: #f8bbd0; /* Header row background color */
...
if (!isset($_GET['id_topic_to_read'])) {
    ...
    <br /><br />
    <a href="read_reply_teacher.php?id_topic_to_readr=123<?php echo $_GET['id_topic_to_read']; ?>">Reply</a>
    <?php
}
?>
<br /><br />
<a href="index_forum_teacher.php">Back to forum home</a>
