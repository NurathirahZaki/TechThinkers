<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class="active"><a href="teacher_backack.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Attendance</a></li> 
		<?php /*?><li class=""><a href="forum/index.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Forum</a></li> <?php */?>
		...
		<li class=""><a href="add_assignment.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Material Upload</a></li> 
		<li class=""><a href="quiz_option.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Quiz</a></li>
		
		<li class=""><a href="insert_marks1.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Grades</a></li>
