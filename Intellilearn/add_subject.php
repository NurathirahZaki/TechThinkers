		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Back</a>
										...
										mysqli_query($conn,"insert into subject (subject_code,subject_title,description,unit,level) values('$subject_code','$title','$description','$unit','$level')")or die(mysqli_error());
