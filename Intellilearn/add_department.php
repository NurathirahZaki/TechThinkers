...
$query = mysqli_query($conn,"select * from department where department_name = '$d' and coordinator = '$pi' ")or die(mysqli_error());
...
mysqli_query($conn,"insert into department (department_name,coordinator) values('$d','$pi')")or die(mysqli_error());
?>
<script>
